...
# km_huang1 = KModes(n_clusters=4, init = "Huang", n_init = 5, verbose=0)
# clusters_huang_1 = km_huang1.fit_predict(dataset_female)
# clusters_huang_1
# filename1 = './models/km_huang111.sav'
# filename3 = './models/clusters_huang111.sav'
# pickle.dump(km_huang1, open(filename1, 'wb'))
# pickle.dump(clusters_huang_1, open(filename3, 'wb'))
# print("Here2")
# # male data
# # Building the model with using K-Mode with "Huang" initialization
# km_huang2 = KModes(n_clusters=4, init = "Huang", n_init = 5, verbose=0)
# clusters_huang_2 = km_huang2.fit_predict(dataset_male)
# clusters_huang_2
# filename2 = './models/km_huang222.sav'
# filename4 = './models/clusters_huang222.sav'
# pickle.dump(km_huang2, open(filename2, 'wb'))
# pickle.dump(clusters_huang_2, open(filename4, 'wb'))
# print("Here3")
...
clusters_huang = km_huang.fit_predict(dataset_categorical)
dataset_categorical.insert(0,"Cluster",clusters_huang, True)
dataset_categorical.head()
filename4 = './models/clusters_huang555.sav'
pickle.dump(km_huang, open(filename4, 'wb'))
dataset_categorical.to_csv(path_or_buf='./data/cardiovascular_disease_prediction_with_clusterss10.csv', sep=';')
target_name = 'cardio'
data_target = dataset_categorical[target_name]
data = dataset_categorical.drop([target_name], axis=1)
